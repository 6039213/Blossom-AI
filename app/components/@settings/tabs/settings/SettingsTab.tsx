...
export default function SettingsTab() {
  ...
  const [settings, setSettings] = useState<UserProfile>(() => {
    const saved = localStorage.getItem('blossom_user_profile');
    return saved
      ? JSON.parse(saved)
      : {
          notifications: true,
  ...
  useEffect(() => {
    try {
      ...
      const existingProfile = JSON.parse(localStorage.getItem('blossom_user_profile') || '{}');
      ...
      localStorage.setItem('blossom_user_profile', JSON.stringify(updatedProfile));
